...
\title{Lepton scale factors using tag and prob method for measurement with single top events at 13 TeV}
...
pdftitle={Lepton scale factors using tag and prob method for measurement with single top events at 13 TeV},%
pdfsubject={CMS},%
...
\bibliography{AN-23-066} % this will be replaced with {auto_generated} when processed by tdr, which is a combination of all .bib files in the directory.
